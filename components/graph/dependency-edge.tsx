          ...
          <Popover>
            ...
            <PopoverContent className="w-64 p-3" side="top">
              <div className="space-y-3">
                ...
                {actions.length === 0 && (
                  <p className="text-xs text-muted-foreground italic text-center py-2 bg-muted/30 rounded">
                    Нет действий
                  </p>
                )}
                ...
                <div className="space-y-2 pt-2 border-t">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="notify_assignee">
                        Уведомить исполнителя
                      </SelectItem>
                      <SelectItem value="notify_creator">
                        Уведомить создателя
                      </SelectItem>
